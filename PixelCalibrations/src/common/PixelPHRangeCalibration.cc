...
//PixelPHRangeCalibration::PixelPHRangeCalibration() : PixelCalibrationBase()
//{
//  std::cout << "Greetings from the PixelPHRangeCalibration default constructor." << std::endl;
//}

PixelPHRangeCalibration::PixelPHRangeCalibration(const PixelSupervisorConfiguration & tempConfiguration, SOAPCommander* mySOAPCmdr)
  : PixelCalibrationBase(tempConfiguration, *mySOAPCmdr)
{
  std::cout << "Greetings from the PixelPHRangeCalibration copy constructor." << std::endl;
}

void PixelPHRangeCalibration::beginCalibration()
{
...
bool PixelPHRangeCalibration::execute()
{
	reportProgress(0.05);
...
void PixelPHRangeCalibration::endCalibration()
{
	PixelCalibConfiguration* tempCalibObject = dynamic_cast <PixelCalibConfiguration*> (theCalibObject_);
	assert(tempCalibObject!=0);
...
std::vector<std::string> PixelPHRangeCalibration::calibrated(){
