...
//PixelVsfAndVHldDelCalibration::PixelVsfAndVHldDelCalibration() : PixelCalibrationBase()
//{
//  std::cout << "Greetings from the PixelVsfAndVHldDelCalibration default constructor." << std::endl;
//}

PixelVsfAndVHldDelCalibration::PixelVsfAndVHldDelCalibration(const PixelSupervisorConfiguration & tempConfiguration, SOAPCommander* mySOAPCmdr)
  : PixelCalibrationBase(tempConfiguration, *mySOAPCmdr)
{
  std::cout << "Greetings from the PixelVsfAndVHldDelCalibration copy constructor." << std::endl;
}

void PixelVsfAndVHldDelCalibration::beginCalibration()
{
...
bool PixelVsfAndVHldDelCalibration::execute()
{
	reportProgress(0.05);
...
void PixelVsfAndVHldDelCalibration::endCalibration()
{
	PixelCalibConfiguration* tempCalibObject = dynamic_cast <PixelCalibConfiguration*> (theCalibObject_);
	assert(tempCalibObject!=0);
...
std::vector<std::string> PixelVsfAndVHldDelCalibration::calibrated(){
